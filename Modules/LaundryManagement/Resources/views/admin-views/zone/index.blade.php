    ...
    <div class="content container-fluid">
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.laundry.zone.store')}}" method="post">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 map-warper" style="height: 300px;">
                            <input id="pac-input" class="controls rounded" style="height: 3em;width: 40%;" title="{{__('messages.search_your_location_here')}}" type="text" placeholder="{{__('messages.search_here')}}"/>
                            ...
                            @foreach($zones as $key=>$zone)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{route('admin.laundry.zone.status',[$zone['id'],$zone->status?0:1])}}" method="get" id="status-{{$zone['id']}}">
                                        </form>
                                    </td>
                                    <td>
                                        <a class="btn btn-sm btn-white"
                                            href="{{route('admin.laundry.zone.edit',[$zone['id']])}}" title="{{__('messages.edit')}} {{__('messages.zone')}}"><i class="tio-edit"></i>
                                        </a>
                                        {{-- <a class="btn btn-sm btn-white" title="Module Setup"
...
@push('script_2')
    ...
    <script>
        ...
        {
            $.get({
                url: '{{route('admin.laundry.zone.zoneCoordinates')}}',
                dataType: 'json',
