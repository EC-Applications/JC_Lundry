    ...
    <div class="content container-fluid">
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.laundry.delivery-man.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        {{-- <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="document[{{$key}}][data]" class="form-control"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="input-label" for="document-{{$key}}-file">{{$document_type['document_title']}} {{trans('messages.file')}} ({{trans("messages.{$document_type['document_type']}")}})</label>
                                    ...
                                    {{-- <div class="custom-file">
                                        ...
                                        <input type="file" class="custom-file-input" name="document[{{$key}}][doc_file][]" id="document-{{$key}}-file" data-limit="{{$document_type['file_count']}}" @if($document_type['file_count']>1) multiple data-toggle="tooltip" data-placement="top" title="If you want to upload multitple files, please select them together." @endif accept="{{$document_type['document_type']=='pdf'?'.pdf':'.png'}}" required>
