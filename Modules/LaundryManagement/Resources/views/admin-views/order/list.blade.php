        ...
        <div class="page-header">
            <div class="row align-items-center mb-3">
                ...
                {{-- <div class="col-3" style="width: 306px;">
                    <select name="zone_id" class="form-control js-select2-custom" onchange="set_zone_filter('{{route('admin.laundry.order.list', ['status' => last(request()->segments())])}}', this.value)">
                ...
                <div class="row justify-content-between align-items-center flex-grow-1">
                    ...
                    <div class="col-lg-6">
                        <div class="d-sm-flex justify-content-sm-end align-items-sm-center">
                            ...
                            <!-- End Datatable Info -->
                            <!-- Unfold -->
                            {{-- @if (Request::path() == 'admin/laundry/order/list/pending' || Request::path() == 'admin/laundry/order/list/confirmed')
...
@push('script_2')
    ...
    {{-- <script>
        $('#assign_dm').on('click', function(){
            var totlaCount = $(".sub_chk:checked").length;
            if (totlaCount>0) {
                $('#myModal').modal('show'); 
            }else{
                toastr.warning('Please select minimum one order to assign rider.', {
                    CloseButton: true,
                    ProgressBar: true
                });
