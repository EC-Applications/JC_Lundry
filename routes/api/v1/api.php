...
Route::group(['namespace' => 'Api\V1'], function () {
    ...
    Route::group(['prefix' => 'delivery-man'], function () {
        ...
        Route::group(['middleware'=>['dm.api']], function () {
            ...
            Route::put('reject-order', 'DeliverymanController@reject_order');
            ...
            Route::post('store-time-log', 'ShiftController@store_time_log');
            Route::get('documents',"DeliverymanController@get_doc");
        });
    });
    ...
    Route::group(['prefix' => 'vendor', 'namespace' => 'Vendor', 'middleware'=>['vendor.api']], function () {
        ...
        Route::get('priority-restaurant', 'VendorController@get_priority_restaurant');
    ...
    Route::group(['prefix' => 'deal'], function(){
        Route::get('list','DealController@get_deals');
    });
    ...
    Route::group(['prefix' => 'restaurants'], function () {
        ...
        Route::get('discounted', 'RestaurantController@get_discounted_restaurant');
