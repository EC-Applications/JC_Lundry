...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix'=>'laundry','as'=>'laundry.','middleware'=>['module:laundry']], function(){
            Route::get('category/status/{id}/{status}', 'LaundryCategoryController@status')->name('category.status');
            Route::resource('category', 'LaundryCategoryController');
        });
        ...
        Route::group(['prefix' => 'food', 'as' => 'food.', 'middleware' => ['module:food']], function () {
            ...
            Route::get('view/{id}/{tab?}', 'FoodController@view')->name('view');
            Route::get('update-priority/{food}', 'FoodController@update_priority')->name('priority');
            //ajax request
        ...
        Route::get('deals/status/{id}/{status}', 'DealController@update_status')->name('deal.status')->middleware('module:campaign');
        Route::get('deals/search', 'DealController@search')->name('deal.search')->middleware('module:campaign');
        Route::resource('deals', 'DealController')->middleware('module:campaign');
        ...
        Route::group(['prefix' => 'vendor', 'as' => 'vendor.'], function () {
            ...
            Route::group(['middleware' => ['module:restaurant']], function () {
                ...
                Route::post('update-agreement/{id}', 'VendorController@update_agreement')->name('update-agreement');
            });
        ...
        Route::group(['prefix' => 'delivery-man', 'as' => 'delivery-man.'], function () {
            ...
            Route::group(['middleware' => ['module:deliveryman']], function () {
                ...
                Route::get('preview/{id}/{tab?}/{sub_tab?}', 'DeliveryManController@preview')->name('preview');
                ...
                Route::post('suspension', 'DeliveryManController@suspension_create')->name('suspension-create');
                Route::delete('suspension/{suspension_id}', 'DeliveryManController@suspension_destroy')->name('suspension-delete');
                ...
                Route::get('settings', 'DeliveryManController@settings')->name('settings');
                Route::post('settings', 'DeliveryManController@update_settings');
                Route::delete('settings/document/{key}', 'DeliveryManController@delete_documents')->name('document.distroy');
                Route::get('rider-performance/{status}', 'DeliveryManController@rider_performance')->name('rider-performance');
                Route::get('delivery-search/{status}', 'DeliveryManController@delivery_search')->name('delivery-search');
        ...
        Route::group(['prefix' => 'report', 'as' => 'report.', 'middleware' => ['module:report']], function () {
            ...
            Route::get('delivered-wise-report/{status}', 'ReportController@delivered_list')->name('delivered-wise-report');
            //Zone Details
            Route::get('zone-details', 'ReportController@zone_details')->name('zone-details');
        });

        Route::group(['prefix' => 'shift', 'as' => 'shift.', 'middleware' => ['module:shift']], function () {
            Route::get('list', 'ShiftController@index')->name('list');
            Route::get('add-new', 'ShiftController@create')->name('add-new');
            Route::post('store', 'ShiftController@store')->name('store');
            Route::get('edit/{id}', 'ShiftController@edit')->name('edit');
            Route::get('view/{id}', 'ShiftController@view')->name('view');
            Route::post('update/{id}', 'ShiftController@update')->name('update');
            Route::delete('delete/{id}', 'ShiftController@delete')->name('delete');
            Route::get('get-shifts', 'ShiftController@get_shifts')->name('get-shifts');
            Route::get('shift-riders', 'ShiftController@shift_riders')->name('shift-riders');
        });
