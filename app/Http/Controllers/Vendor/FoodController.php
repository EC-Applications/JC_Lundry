...
class FoodController extends Controller
{
    ...
    public function view($id, $tab = 'details')
    {
        ...
        return view('vendor-views.product.view', compact('product', 'reviews', 'tab', 'logs'));
    }
    ...
    public function list(Request $request)
    {
        ...
        $foods = Food::when(is_numeric($category_id), function ($query) use ($category_id) {
            ...
            ->type($type)->where('restaurant_id', Helpers::get_restaurant_id())->latest()->paginate(config('default_pagination'));
