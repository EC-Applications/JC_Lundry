...
class UpdateController extends Controller
{
    ...
    public function update_software(Request $request)
    {
        ...
        Helpers::insert_business_settings_key('number_of_orders_in_checkout','10');
        Helpers::insert_business_settings_key('dm_max_cash_in_hand', '10000');
        Helpers::insert_business_settings_key('laundry_tax', 0);
        Helpers::insert_business_settings_key('minimum_pickup_time_for_laundry_order', 0);
