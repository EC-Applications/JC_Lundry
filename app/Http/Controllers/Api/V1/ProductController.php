...
class ProductController extends Controller
{
    ...
    public function get_popular_products(Request $request)
    {
        ...
        $zone_id= $request->header('zoneId');
        $products = ProductLogic::popular_products($zone_id, $type, $request['limit'], $request['offset']);
        $products['products'] = Helpers::product_data_formatting($products['products'], true);
        return response()->json($products, 200);
    }    
    ...
    public function get_most_reviewed_products(Request $request)
    {
        ...
        $zone_id= $request->header('zoneId');
        $products = ProductLogic::most_reviewed_products($zone_id, $type, $request['limit'], $request['offset']);
        $products['products'] = Helpers::product_data_formatting($products['products'], true);
        return response()->json($products, 200);
    }
