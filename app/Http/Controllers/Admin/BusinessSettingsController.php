...
class BusinessSettingsController extends Controller
{
    ...
    public function business_setup(Request $request)
    {
        ...
        DB::table('business_settings')->updateOrInsert(['key' => 'multi_restaurant_order'], [
            'value' => $request['multi_restaurant_order']
        ]);
        ...
        DB::table('business_settings')->updateOrInsert(['key' => 'laundry_tax'], [
            'value' => $request['laundry_tax']
        ]);
        ...
        DB::table('business_settings')->updateOrInsert(['key' => 'number_of_orders_in_checkout'], [
            'value' => $request['number_of_orders_in_checkout']
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'number_of_items_per_order'], [
            'value' => $request['number_of_items_per_order']
        ]);
        DB::table('business_settings')->updateOrInsert(['key' => 'order_max_idle_time'], [
            'value' => $request['order_max_idle_time']
        ]);
        DB::table('business_settings')->updateOrInsert(['key' => 'dm_max_cash_in_hand'], [
            'value' => $request['dm_max_cash_in_hand']
        ]);
        DB::table('business_settings')->updateOrInsert(['key' => 'minimum_pickup_time_for_laundry_order'], [
            'value' => $request['minimum_pickup_time_for_laundry_order']
        ]);
    ...
    public function payment_update(Request $request, $name)
    {
        ...
        } elseif($name == 'simpaisa'){
            DB::table('business_settings')->updateOrInsert(['key' => 'simpaisa'], [
                'value' => json_encode([
                    'status' => $request['status'],
                    'merchant_id' => $request['merchant_id']
                ]),
        ...
        elseif($name == 'payfast'){
            DB::table('business_settings')->updateOrInsert(['key' => 'payfast'], [
                'value' => json_encode([
                    'status' => $request['status'],
                    'mode' => $request['mode'],
    ...
    {
        if(!$data = BusinessSetting::where('key', 'social_login')->first()){
            $data = new BusinessSetting();
            $data->value = '[{"login_medium":"google","client_id":"","client_secret":"","status":"0"},{"login_medium":"facebook","client_id":"","client_secret":"","status":""}]';
            Helpers::insert_business_settings_key('social_login',$data->value);
        }
