...
return [
    ...
    'food_priority_updated successfully' => 'Food priority updated successfully!',
    ...
    'deliveryman_preview' => 'Rider Preview',
    'delivery_zone' => 'Delivery Zone',
    'delivery_charge' => 'Delivery Fee',
    'delivery_address_updated' => 'Delivery address updated!',
    'deliveryman_earning_type' => 'Rider man earning type',
    'deny' => 'deny',
    'designation' => 'Designation',
    'dm_maximum_order' => 'Maximum assigned orders for Rider',
    'dm_maximum_order_hint' => 'Number of maximum orders a rider can serve at a time',
    'dm_maximum_order_exceed_warning' => 'Rider maximum serving orders exceed!',
    ...
    'deliveryman_registration' => 'Rider Registration',
    'deliveryman_application' => 'Rider Application',
    ...
    'order_varification_toggle' => 'If this field is active then customer have to provide a OTP code to rider for delivered a order successfully',
    ...
    'owner' => 'Owner',
    'order' => 'Order',
    'order_already_assign_to_this_deliveryman' => 'Already assign to this Rider',
    ...
    'provide' => 'provide',
    'provided_dm_earnings_removed' => 'Provide rider earnings removed!',
    ...
    'searchingDM' => 'Searching Rider',
    'searching_for_deliverymen' => 'Searching For Rider',
    ...
    'unsuspend_this_delivery_man' => 'Unsuspend This Rider',
    'suspend_this_delivery_man' => 'Suspend This Rider',
    'suspended' => 'Suspended',
    ...
    'accepted' => 'Accepted',
    'acceptedbyDM' => 'Accepted By Rider',
    ...
    'deliveryman' => 'Rider',
    'deliverymen' => 'Riders',
    'deliveryman_type_updated' => 'Rider type updated!',
    'deliveryman_status_updated' => 'Rider status updated!',
    'deliveryman_added_successfully' => 'Rider added successfully!',
    'deliveryman_updated_successfully' => 'Rider updated successfully!',
    'deliveryman_deleted_successfully' => 'Rider deleted successfully!',
    'earning' => 'Earning',
    'report' => 'Report',
    'reports' => 'Reports',
    'web_and_app' => 'Web & App',
    ...
    'please_assign_deliveryman_first' => 'Please assign Rider first!',
    ...
    'you_want_to_suspend_this_deliveryman' => 'Want to suspend this rider ?',
    'you_want_to_unsuspend_this_deliveryman' => 'Want to unsuspend this rider ?',
    ...
    'assign_delivery_mam_manually' => 'Assign rider munally',
    ...
    'top_deliveryman' => 'Top rider by order count',
    ...
    'You_can_not_change_status_after_picked_up_by_delivery_man' => 'You can not change status after picked up by Rider!',
    ...
    'want_to_disable_earnings' => 'Want to change the rider type to salary based?',
    'want_to_enable_earnings' => 'Want to change the rider type to freelancer?',
    ...
    'deliveryman_cancellation_toggle' => 'Rider can cancel a order',
    'time_zone' => 'Time Zone',
    'time_format' => 'Time Format',
    '12_hour' => '12H',
    '24_hour' => '24H',
    'language' => 'Language',
    'show_earning_for_each_order' => 'Show earning for each order (Rider app)',
    'order_canceled_confirmation' => 'You want to cancel this order?',
    'first_name_is_required' => 'First name is required!',
    'select_a_zone' => 'Please select a zone!',
    'select_dm_type' => 'Please select Rider type!',
    ...
    'deal_unavailable_warning' => 'Deal in your cart is not available. Please clear your cart and try again.',
    ...
    'dm_self_registration' => 'Rider self registration',
    ...
    'Simpaisa' => 'Simpaisa',
    'number_of_orders_in_checkout' => 'Maximum number of orders in a checkout',

    //Customisation
    'multi_restaurant_order' => 'Multi restaurant order',
    'multi_restaurant_order_hint' => 'If this field is enabled customer will be able to order from multiple restaurant at a time',
    'operator' => 'Operator',
    'MSISDN' => 'MSISDN',
    'enter_otp' => 'Enter OTP',
    'deals' => 'Deals',
    ...
    'deal_title' => 'Buy one get one free',
    'add_choice' => 'Add choice',
    'choice_list' => 'Choice List',
    'no_options_warning' => 'No food selected!',
    'remove_this_choice' => 'Remove this choice',
    'choice' => 'Choice',
    'add_new_deal' => 'Add new deal',
    'edit_deal' => 'Edit deal',
    'start_at' => 'Start at',
    ...
    'restaurant_wise_delivery_fee' => 'Restaurant wise delivery fee',
    'self_delivery_restaurant_sc_warning' => 'Please disable restaurant wise delivery charge to enable self delivery system',
    'restaurant_sc_enable_warning' => 'Please disable self delivery system to enable restaurant wise delivery charge',
    'delivery_man_settings' => 'Delivery man settings',
    'document_title' => 'Document title',
    'input_type' => 'Input type',
    'number_of_files' => 'Number of files',
    'document_type_added' => 'Documnet type added successfully!',
    'document_type_deleted' => 'Documnet type deleted successfully!',
    'maximum_upload_limit' => 'Maximum upload limit ',
    'files' => ' files',
    'suspension_logs' => ' Suspension Logs',
    'create_supension' => ' Create Suspension',
    'shift' => 'Shift',
    'shift_list' => 'Shift List',
    'parent_shift' => 'Parent Shift',
    'special' => 'Special',
    'log_create_success_message' => 'Log created successfully!',
    'shift_not_found' => 'Shift not found!',
    'start_time' => 'Start Time',
    'end_time' => 'End Time',
    'shift_saved_successfully' => 'Shift saved successfully',
    'special_shift_already_exists' => 'Special shift already exists for that date',
    'morning_shift' => 'Morning shift',
    'schedule_overlapping_warning' => 'This schedule is overlaping another schedule',
    'shift_updated_successfully' => 'Shift updated successfully',
    'add_special_shift' => 'Add special shift',
    'time_logs' => 'Time logs',
    'total_duration' => 'Total duration',
    'no_show_excused' => 'no show(excused)',
    'no_show' => 'no show',
    'performed' => 'performed',
    'order_cash_in_hand' => 'Collected cash order',
    'settled_cash_transaction' => 'Collected cash by admin',
    'current_balance' => 'Current balance',
    'earning_settled' => 'Earning provided to rider',
    'settled_earning_transaction' => 'Settled earning transactions',
    'settled_cash_in_hand' => 'Cash collected by admin',
    'total_collected_cash' => 'Total collected cash',
    'settled_earning_balance' => 'Earning provided to rider',
    'deliveryman_preview' => 'Rider Preview',
    'rider_documents' => 'Rider documents',
    'canceled_or_failed' => 'Canceled or failed',
    'deliveryman_performance_report' => 'Rider performance report',
    'performance_report' => 'Performance report',
    'personal_details' => 'Personal details',
    'na' => "N/A",
    'order_journey' => 'Order journey',
    'order_place_time' => 'Order place time',
    'order_accepted_by_rider' => 'Order accepted by rider',
    'order_accepted_by_vendor' => 'Order accepted by vendor',
    'rider_reached_pickup_location' => 'Rider reached pickup location',
    'rider_picks_up_order' => 'Rider picks up order',
    'rider_reached_pickup_location' => 'Rider reached pickup location',
    'customer_receives_notification_of_rider_arrival' => 'Customer receives notification of rider arrival',
    'rider_delivered_and_marked_completed' => 'Rider delivered and marked completed',
    'documents' => 'Documents',
    'rider_details' => 'Rider details',
    'joining_date' => 'Joining date',
    'suspension_begins' => 'Suspension begins',
    'suspension_end' => 'Suspension end',
    'suspension_details' => 'Suspension details',
    'suspension_date' => 'Suspension date',
    'edit_suspension' => 'Edit suspension',
    'add_suspension' => 'Add suspension',
    'rider_suspension_deleted_successfully' => 'Rider suspension deleted successfully',
    ...
    'id :' => 'ID :',
    'phone :' => 'PHONE :',
    'currently_assign_orders' => 'Currently Assign Orders',
    ...
    'Normal' => 'Normal',
    'Special' => 'Special',
    'acceptance_rate' => 'Order Acceptance Rate',
    'rejection_rate' => 'Rejection Rate',
    'priority_hint' => 'The highest priority number will show first',
    'enter_verification_code' => 'Enter order verification code',
    ...
    'can_edit_agreement' => 'Can edit agreement',
    'agremeent_uploaded' => 'Agreement uploaded',
    'agreement' => 'Agreement',
    'choose_file' => 'Choose File',
    'you_want_to_update_the_agreement' => 'You want to update the agreement?',
    'edit_restaurant' => 'Edit restaurant',
    'you_dont_have_permission_to_edit_the_agremeent' => 'Sorry!You don`t have permission to edit the agremeent',
    'log' => 'Log',
    'user_type' => 'User Type',
    ...
    'sl' => 'SL',
    'doc_already_exits'=>':type already exits!',
    'order_canceled_by_restaurant'=>'Order has been Canceled By Restaurant',
    'order_max_idle_time'=>'Maximum idle time for an order',
    'minute'=>'minute',
    'payfast'=>'PayFast',
    'Mode'=>'Mode',
    'Test'=>'Test',
    ...
    'system_module_management' => 'System Module Mangement',
    ...
    'add_new_laundry_item' => 'Add New Laundry Item',
    'service_setup' => 'Service Setup',
    'services_name' => 'Service Name',
    'laundry_services' => 'Laundry Services',
    'serivice_wise_item_price_updated_successfully' => 'Serivice wise item price updated successfully',
    'laundry_item_deleted_successfully' => 'Laundry item deleted successfully',
    'laundry_item_added_successfully' => 'Laundry item added successfully',
    'select_service' => 'Select Service',
    'add_new_laundry' => 'Add New Laundry',
    'banner_added_successfully' => 'Banner added successfully',
    'laundry_item_status_updated' => 'Laundry item status updated',
    'delivery_type_setup' => 'Delivery Type Setup',
    'new_delivery_type_name' => 'New Delivery Type Name',
    'add_new_laundry_delivery_types' => 'Add New Laundry Delivery Types',
    'duration_in_day' => 'Duration in day',
    'minimum_delivery_fee' => 'Minimum Delivery Fee',
    'laundry_delivery_types' => 'Laundry Delivery Types',
    'per_km_delivery_fee' => 'Per KM Delivery fee',
    'delivery_type_added_successfully' => 'Delivery type added successfully',
    'delivery_type_status_updated' => 'Delivery type status updated',
    'delivery_type_updated_successfully' => 'Delivery type updated successfully',
    'laundry_delivery_type' => 'Laundry Delivery Type',
    'delivery_type_deleted_successfully' => 'Delivery type deleted successfully',
    'laundry' => 'Laundry',
    'pickup' => 'Pickup',
    'destination' => 'Destination',
    'order_confirmed_time' => 'Order confirmed time',
    'order_processing_at' => 'Order processing at',
    'out_for_pickup' => 'Out for pickup',
    'picked_up' => 'Picked up',
    'arrived' => 'Arrived',
    'delivery_zone_setup' => 'Delivery Zone Setup',
    ...
    'order_updated_successfully' => 'Order updated successfully',
    'service_not_available_right_now' => 'Service not available right now',
    'selected' => 'Selected',
    'you_do_not_belong_to_laundry_delivery_service' => 'You do not belong to laundry delivery service',
    'quantity_must_be_zero' => 'Quantity must be zero',
    'dispatch_section' => 'Dispatch Section',
    'in_house_tracking' => 'In-House Tracking',
    'facility_room_check' => 'Facility Room Check',
    'update_laundry_order_status' => 'Update Laundry Order Status',
    'enter_package_barcode' => 'Enter Package Barcode',
    'barcode' => 'Barcode',
    'processing_items' => 'Processing Items',
    'delivery_type_not_found_or_not_active' => 'Delivery type not found or not active',
    'ready_for_delivery' => 'Ready For Delivery',
    'update_laundry_product_status' => 'Update Lundry Product Status',
    'enter_product_barcode' => 'Enter Product Barcode',
    'generate_barcode_for_items' => 'Generate Barcode For Items',
    'vehicle_type' => 'Vehicle Type',
    'add_new_laundry_vehicle_type' => 'Add New Laundry Vehicle Type',
    ...
    'vehicle_type_status_updated_successfully' => 'Vehicle type status updated successfully',
    'vehicle_type_deleted_successfully' => 'Vehicle type deleted successfully',
    'new_vehicle_type' => 'New vehicle type',
    'destination_address_updated' => 'Destination address updated',
    'pickup_address_updated' => 'Pickup address updated',
    'laundry_zone_id_required' => 'Laundry zone id required',
    'product_arrival' => 'Product Arrival',
    'product_arrival_status_in_facility_room' => 'Product Arrival Status in Facility Room',
    ...
    'print' => 'Print',
    'order_belongs_to_id' => 'Order Belongs to ID',
    'your_updated_item' => 'your updated item',
    'other_items' => 'Other Items',
    'click_to_view_barcode' => 'Click to view barcode',
    'assign_pickup_delivery_man_manually' => 'Assign Pickup Rider Manually',
    'assign_delivery_man_for_delivery_manually' => 'Assign Delivery Rider Manually',
    'pickup_deliveryman' => 'Pickup Rider',
    'deliveryman_for_delivery' => 'Delivery Rider',
    'change_delivery_deliveryman' => 'Change Delivery Rider',
    'change_pickup_deliveryman' => 'Change Pickup Rider',
    'picture_saved_succesfully' => 'Picture Saved Successfully',
    'picture_saving_failed' => 'Picture Saving Failed',
    ...
    'laundry_tax' => 'Laundry Tax',
    'you_have_a_new_order_request' => 'You have a new order request!',
    'minimum_one_delivery_type_need_to_active' => 'Minimum one delivery type need to active',
    'pickup_or_delivery_images' => 'Pickup or delivery images',
    'pickup_images' => 'Pickup images',
    'delivery_images' => 'Delivery images',
    'minimum_pickup_time_for_laundry_order' => 'Minimum pickup time for laundry order',
    'This minimum pickup time is only works for laundry orders.' => 'This minimum pickup time is only works for laundry orders.',
    'package_arrival_and_process' => 'Package Arrival And Process',
    'package_arrival_status_in_facility_room' => 'Package Arrival Status in Facility Room',
