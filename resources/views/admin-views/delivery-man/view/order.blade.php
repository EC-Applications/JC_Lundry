        ...
        <div class="row">
            ...
            <div class="js-nav-scroller hs-nav-scroller-horizontal">
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('admin.delivery-man.preview', ['id' => $dm->id, 'tab' => 'order']) }}" aria-disabled="true">{{ __('messages.orders') }}</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="card w-100">
                        <div class="card-header">
                            ...
                            <div class="col-sm-auto" style="min-width: 306px;">
                                <select name="status" class="form-control js-select2-custom"
                                        onchange="set_filter('{{route('admin.delivery-man.preview',['id'=>$dm->id, 'tab'=> 'order'])}}',this.value, 'status')">
                        ...
                        <div class="card-body mb-3 mb-lg-5 border-bottom">
                            <div class="row gx-lg-4">
                                <div class="col-sm-6 col-lg-3">
                                    <div class="media" style="cursor: pointer">
                                        <div class="media-body">
                                            <h6 class="card-subtitle">{{__('messages.on_going')}}</h6>
                                            <span class="card-title h3">{{$dm['ongoing_orders']}}</span>
                                        </div>
                                ...
                                <div class="col-sm-6 col-lg-3 column-divider-sm">
                                    <div class="media" style="cursor: pointer">
                                        <div class="media-body">
                                            ...
                                            <span class="card-title h3">{{$dm['delivered_orders']}}</span>
                                        </div>
                                        <span class="icon icon-sm icon-soft-secondary icon-circle ml-3">
                                ...
                                <div class="col-sm-6 col-lg-2 column-divider-lg">
                                    <div class="media" style="cursor: pointer">
                                        <div class="media-body">
                                ...
                                <div class="col-sm-6 col-lg-2 column-divider-sm">
                                    <div class="media" style="cursor: pointer">
                                        <div class="media-body">
                                            <h6 class="card-subtitle">{{__('messages.all')}}</h6>
                                            <span class="card-title h3">{{$dm['all']}}</span>
                                        </div>
                                        <span class="icon icon-sm icon-soft-secondary icon-circle ml-3">
                                        <i class="tio-table"></i>
                                        </span>
                                ...
                                <div class="col-sm-6 col-lg-2 column-divider-sm">
                                    <div class="media" style="cursor: pointer">
                                        <div class="media-body">
                                            <h6 class="card-subtitle">{{__('messages.acceptance_rate')}}</h6>
                                            {{-- ({{ count($order_payment_methods)>0?isset($order_payment_methods[0])?$order_payment_methods[0]->total_order_amount:0:0 }}) --}}

                                            @if ($order_logs->count() == 1)
                                                @php($order_accept_count = $order_logs[0]->is_accept == 1 ? $order_logs[0]->order_count : 0)
                                                @php($order_reject_count = $order_logs[0]->is_accept == 0 ? $order_logs[0]->order_count : 0)

                                                @php($total_order_logs =$order_reject_count+$order_accept_count)
                                                <span class="card-title h3">{{$order_accept_count > 0 ? round($order_accept_count / $total_order_logs * 100) : 0}}%</span>
                                            @elseif ($order_logs->count() == 2)
                                                @php($order_accept_count = $order_logs[0]->is_accept == 1 ? $order_logs[0]->order_count : 0)
                                                @php($order_reject_count = $order_logs[0]->is_accept == 0 ? $order_logs[0]->order_count : 0)
                                                @php($order_accept_count = $order_logs[1]->is_accept == 1 ? $order_logs[1]->order_count : 0)
                                                @php($order_reject_count = $order_logs[1]->is_accept == 0 ? $order_logs[1]->order_count : 0)
                        ...
                        <div class="row d-flex justify-content-around">
                            <div class="col-lg-4">
                                <form method="GET"
                                    action="{{route('admin.delivery-man.preview', ['id'=>$dm->id, 'tab'=> 'order'])}}">
                            ...
                            <div class="col-auto justify-content-end">
                                    <form method="GET" action="{{route('admin.delivery-man.preview', ['id'=>$dm->id, 'tab'=> 'order'])}}">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
