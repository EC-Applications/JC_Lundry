            ...
            <div class="card-header">
                <div class="row justify-content-between align-items-center flex-grow-1">
                    <div class="col-lg-6 mb-3 mb-lg-0">
                        <form action="{{ route('admin.delivery-man.rider-performance',['all'] ) }}" method="GET">
                         <!-- Search -->
            ...
            <div class="card-header">
                ...
                <div class="col-sm-auto" style="min-width: 306px;">
                    <select name="status" class="form-control js-select2-custom"
                            onchange="set_filter('{{url('admin.delivery-man.preview',['tab'=> 'order'])}}',this.value, 'status')">
            ...
            <div class="card-body mb-3 mb-lg-5">
                <div class="row gx-lg-4">
                    <div class="col-sm-6 col-lg-2">
                        <div class="media" style="cursor: pointer">
                            <div class="media-body">
                                ...
                                <span class="card-title h3">{{$orders->sum('ongoing_orders')}}</span>
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-2">
                        <div class="media" style="cursor: pointer">
                            <div class="media-body">
                                ...
                                <span class="card-title h3">{{$orders->sum('delivered_orders')}}</span>
                            </div>
                            <span class="icon icon-sm icon-soft-secondary icon-circle ml-3">
                            <i class="tio-airdrop"></i>
                            </span>
                    ...
                    <div class="col-sm-6 col-lg-2">
                        <div class="media" style="cursor: pointer">
                            <div class="media-body">
                                <h6 class="card-subtitle">{{__('messages.rejected')}}</h6>
                                <span class="card-title h3">{{$orders->sum('canceled_or_failed_orders')}}</span>
                            </div>
                            <span class="icon icon-sm icon-soft-secondary icon-circle ml-3">
                            <i class="tio-airdrop"></i>
                            </span>
                    ...
                    <div class="col-sm-6 col-lg-2 column-divider-lg">
                        <div class="media" style="cursor: pointer">
                            <div class="media-body">
                                <h6 class="card-subtitle">{{__('messages.rejection_rate')}}</h6>
            ...
            <div class="table-responsive datatable-custom">
                <table id="datatable"
                    ...
                    <tr>
                        ...
                        <th>{{__('messages.delivery_man')}}</th>
                    ...
                    <tr class="status-{{$order['order_status']}} class-all">
                        ...
                        <td>
                                ...
                                <a class="text-body text-capitalize"
                                href="{{ route('admin.delivery-man.preview', [$order->delivery_man->id]) }}">{{$order->delivery_man['f_name'].' '.$order->delivery_man['l_name']}}
                          <h6>
                            <span>{{ __('messages.id :') }} {{$order->delivery_man->id}}
                                </span>
                          </h6>
                          <h6>
                            <span>{{ __('messages.phone :') }} {{$order->delivery_man->phone}}
                                </span>
                          </h6>
                            </a>
                        </td>
