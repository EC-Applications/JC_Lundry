            ...
            <div class="table-responsive datatable-custom">
                <table id="datatable"
                    ...
                    @foreach($orders as $key=>$order)
                        ...
                        <tr class="status-{{$order['order_status']}} class-all {{($order_max_idle_time->gt($updated_at) && (in_array($order->order_status, ['accepted','confirmed','processing','handover','picked_up']) || ($order->order_status == 'pending' && !$order->scheduled))) ? 'bg--warning':''}}">
                            <td class="">
