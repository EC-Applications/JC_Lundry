                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" min="0" step="1" name="minimum_delivery_time" class="form-control" placeholder="30" pattern="^[0-9]{2}$" required value="{{explode('-',$restaurant->delivery_time)[0]}}">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="input-label" for="maximum_delivery_time">{{__('messages.maximum_delivery_time')}}</label>
                                    <input type="number" min="0" step="1" name="maximum_delivery_time" class="form-control" placeholder="40" pattern="[0-9]{2}" required value="{{explode('-',$restaurant->delivery_time)[1]}}">
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <select name="module_id" required class="form-control js-select2-custom"  data-placeholder="{{__('messages.select')}} {{__('messages.module')}}" disabled>
                                    ...
                                    @foreach(\App\Models\Module::notLaundry()->get() as $module)
                                        <option value="{{$module->id}}" {{$restaurant->module_id==$module->id?'selected':''}}>{{$module->module_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="any" min="-90" max="90"
                                       ...
                                       placeholder="Ex : -84.22213" value="{{$restaurant->latitude}}" required>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" step="any" min="-180" max="180"
                                       ...
                                       placeholder="Ex : 103.344322" value="{{$restaurant->longitude}}" required>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                value="{{$restaurant->phone}}"   oninput="this.value = this.value.replace(/[^+.0-9.-]/g, '').replace(/(\..*)\./g, '$1');"  required maxlength="20" minlength="10">
                            </div>
                        </div>
                    </div>
                    <br>
