                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="card-title m-0 d-flex align-items-center">
                                ...
                                <span class="ml-1">{{trans('messages.agreement')}}</span>
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 collapse my-2" id="collapseAggrement">
                                    <form action="{{route('admin.vendor.update-agreement',['id'=>$restaurant->id])}}" enctype="multipart/form-data" method="POST" id="agreement_upload">
                                        @csrf
                                ...
                                <div class="col-12 d-flex justify-content-center">
                                    @if ($restaurant->agreement)
                                        <a class="btn btn-primary mr-3" href="{{asset("/storage/app/public/restaurant/agreement/{$restaurant->agreement}")}}" target="_blank">{{trans('messages.view')}}</a>
                                    @endif
                                    <a class="btn btn-warning" data-toggle="collapse" href="#collapseAggrement" role="button" aria-expanded="false" aria-controls="collapseAggrement">{{trans('messages.update')}}</a>                            
                                </div>
                            </div>
                        </div>
                    </div>
