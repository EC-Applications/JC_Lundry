        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-filter-list"></i> {{ __('messages.shift') }}</h1>
                </div>
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5>{{ __('messages.shift') }} {{ __('messages.list') }}<span class="badge badge-soft-dark ml-2"
                        ...
                        <div class="col-sm-auto" style="min-width: 306px;">
                            <select name="zone_id" class="form-control js-select2-custom"
                                    onchange="set_zone_filter('{{route('admin.shift.list')}}',this.value)">
                            ...
                            <tbody id="set-rows">
                                @foreach ($shifts as $key => $shift)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="d-block text-body">{{ $shift->zone->name }}
                                            </span>
                                        </td>
                                        <td>
                                            <span
                                        ...
                                        <td>
                                            <span
                                                class="bg-gradient-light text-dark">{{ $shift->special_date ? date('Y/m/d', strtotime($shift->special_date)) : 'N/A' }}</span>
                                        </td>
                                        <td>
