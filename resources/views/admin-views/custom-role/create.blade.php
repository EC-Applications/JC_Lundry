                ...
                <div class="card-body">
                    <form action="{{route('admin.custom-role.create')}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-check">
                                    <input type="checkbox" name="modules[]" value="log" class="form-check-input"
                                            id="withdraw_list">
                                    <label class="form-check-label qcont text-dark" for="withdraw_list">{{__('messages.activity_log')}}</label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group form-check">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-check">
                                    <input type="checkbox" name="modules[]" value="laundry" class="form-check-input"
                                           id="laundry">
                                    <label class="form-check-label qcont text-dark" for="laundry">{{__('messages.laundry_module')}}</label>
                                </div>
                            </div>
                        </div>
