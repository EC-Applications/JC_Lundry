    ...
    <div class="content container-fluid">
        ...
        <div class="row digital_payment_methods" style="padding-bottom: 20px">
            ...
            <div class="col-md-6 mt-4">
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        <h5 class="text-center">{{__('messages.Simpaisa')}}</h5>
                        @php($config=\App\CentralLogics\Helpers::get_business_settings('simpaisa'))
                        <form
                            action="{{env('APP_MODE')!='demo'?route('admin.business-settings.payment-method-update',['simpaisa']):'javascript:'}}"
                            method="post">
                            @csrf
                            @if(isset($config))
                                <div class="form-group mb-2">
                                    <label class="control-label">{{__('messages.Simpaisa')}}</label>
                                </div>
                                <div class="form-group mb-2 mt-2">
                                    <input type="radio" name="status" value="1" {{$config['status']==1?'checked':''}}>
                                    <label style="padding-left: 10px">{{__('messages.active')}}</label>
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{__('messages.merchant')}} {{__('messages.id')}}</label><br>
                                    <input type="text" class="form-control" name="merchant_id"
                                           value="{{env('APP_MODE')!='demo'?$config['merchant_id']:''}}">
                                </div>
            ...
            <div class="col-md-6 mt-4">
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        <h5 class="text-center">{{__('messages.payfast')}}</h5>
                        <div class="payment--gateway-img mt-5">
                            </div>
                        @php($config=\App\CentralLogics\Helpers::get_business_settings('payfast'))
                        <form
                            action="{{env('APP_MODE')!='demo'?route('admin.business-settings.payment-method-update',['payfast']):'javascript:'}}"
                            method="post">
                            @csrf
                            @if(isset($config))
                                <div class="form-group mb-2">
                                    <label class="control-label">{{__('messages.payfast')}}</label>
                                </div>
                                <div class="form-group mb-2 mt-2">
                                    <input type="radio" name="status" value="1" {{$config['status']==1?'checked':''}}>
                                    <label style="padding-left: 10px">{{__('messages.active')}}</label>
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{__('messages.Mode')}}</label><br>
                                   <select name="mode" id="" class="form-control">
                                    <option value="test" {{$config['mode']=='test'?'selected' :'' }}>{{__('messages.Test')}}</option>
                                    <option value="live" {{$config['mode']=='live'?'selected' :'' }}>{{__('messages.Live')}}</option>
                                   </select>
                                </div>
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{__('messages.merchant')}} {{__('messages.name')}}</label><br>
                                    <input type="text" class="form-control" name="merchant_name"
                                           value="{{env('APP_MODE')!='demo'?(isset($config['merchant_name'])?$config['merchant_name']:''):''}}">
                                </div>
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{__('messages.merchant')}} {{__('messages.id')}}</label><br>
                                    <input type="text" class="form-control" name="merchant_id"
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{__('messages.Secured')}} {{__('messages.key')}}</label><br>
                                    <input type="text" class="form-control" name="secured_key"
                                           value="{{env('APP_MODE')!='demo'?$config['secured_key']:''}}">
                                </div>
