            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.business-settings.update-setup')}}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-12">
                            @php($multi_restaurant_order=\App\Models\BusinessSetting::where('key','multi_restaurant_order')->first())
                            @php($multi_restaurant_order=$multi_restaurant_order?$multi_restaurant_order->value:'0')
                            <div class="form-group">
                                <label class="input-label d-inline">{{__('messages.multi_restaurant_order')}}</label><small style="color: red">
                                <span class="input-label-secondary" title="{{__('messages.multi_restaurant_order_hint')}}"><img src="{{asset('/public/assets/admin/img/info-circle.svg')}}"></span>
                                 *</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1" name="multi_restaurant_order"
                                                   id="multi_restaurant_order" {{$multi_restaurant_order=='1'?'checked':''}}>
                                            <label class="custom-control-label" for="multi_restaurant_order">{{__('messages.on')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0" name="multi_restaurant_order"
                                                   id="multi_restaurant_order2" {{$multi_restaurant_order=='0'?'checked':''}}>
                                            <label class="custom-control-label" for="multi_restaurant_order2">{{__('messages.off')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                    ...
                    <div class="row">
                        ...
                        @php($admin_commission=\App\Models\BusinessSetting::where('key','admin_commission')->first())
                            <div class="form-group p-2">
                                ...
                                <input type="number" name="admin_commission" class="form-control" id="admin_commission" value="{{$admin_commission?$admin_commission->value:0}}" min="0" max="100" step=".01" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-12">
                            @php($laundry_tax=\App\Models\BusinessSetting::where('key','laundry_tax')->first())
                                <div class="form-group p-2">
                                    <label class="input-label d-inlin" for="laundry_tax"><label class="input-label d-inline">{{__('messages.laundry_tax')}}</label><small style="color: red"><span
                                        class="input-label-secondary" title="{{__('messages.laundry_tax')}}"><img src="{{asset('/public/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.laundry_tax')}}"></span> *</small>         
                                    <input type="number" name="laundry_tax" class="form-control" id="laundry_tax" value="{{$laundry_tax?$laundry_tax->value:0}}" min="0" max="100" step=".01" required>
                                </div>
                            </div>

                        <div class="col-md-4 col-12">
                        @php($number_of_orders_in_checkout=\App\Models\BusinessSetting::where('key','number_of_orders_in_checkout')->first())
                            <div class="form-group p-2">
                                <label class="input-label text-capitalize" for="number_of_orders_in_checkout">{{__('messages.number_of_orders_in_checkout')}}</label>
                                <input type="number" name="number_of_orders_in_checkout" class="form-control" id="number_of_orders_in_checkout" value="{{$number_of_orders_in_checkout?$number_of_orders_in_checkout->value:0}}" min="0" required>
                            </div>
                        </div>  
                        
                        <div class="col-md-4 col-12">
                        @php($number_of_items_per_order=\App\Models\BusinessSetting::where('key','number_of_items_per_order')->first())
                            <div class="form-group p-2">
                                <label class="input-label text-capitalize" for="number_of_items_per_order">{{__('messages.number_of_items_per_order')}}</label>
                                <input type="number" name="number_of_items_per_order" class="form-control" id="number_of_items_per_order" value="{{$number_of_items_per_order?$number_of_items_per_order->value:0}}" min="0" required>
                            </div>
                        </div>  
                        ...
                        @php($order_max_idle_time=\App\Models\BusinessSetting::where('key','order_max_idle_time')->first())
                            <div class="form-group p-2">
                                <label class="input-label text-capitalize" for="order_max_idle_time">{{__('messages.order_max_idle_time')}} ({{trans('messages.minute')}})</label>
                                <input type="number" name="order_max_idle_time" class="form-control" id="order_max_idle_time" value="{{$order_max_idle_time?$order_max_idle_time->value:0}}" min="0" required>
                            </div>
                        </div>  
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                <label class="input-label d-flex text-capitalize"
                                    ...
                                    <span class="line--limit-1">
                                        {{trans('Delivery Man Maximum Cash in Hand')}} ({{ \App\CentralLogics\Helpers::currency_symbol() }})
                                    </span>

                                    <span data-toggle="tooltip" data-placement="right" data-original-title="{{trans('If the cash in hand for a delivery man exceeds this amount the delivery man cannot accept new orders before depositing the amount to admin.')}}" class="input-label-secondary"><img src="{{ asset('/public/assets/admin/img/info-circle.svg') }}" alt="{{ trans('messages.dm_maximum_order_hint') }}"></span>
                        ...
                        <div class="col-md-4 col-12">
                            @php($minimum_pickup_time_for_laundry_order = \App\Models\BusinessSetting::where('key', 'minimum_pickup_time_for_laundry_order')->first())
                            <div class="form-group">
                                <label class="input-label d-flex text-capitalize"
                                    for="=minimum_pickup_time_for_laundry_order">

                                    <span class="line--limit-1">
                                        {{trans('messages.minimum_pickup_time_for_laundry_order')}} ({{ trans('messages.min') }})
                                    </span>

                                    <span data-toggle="tooltip" data-placement="right" 
                                        data-original-title="{{trans('messages.This minimum pickup time is only works for laundry orders.')}}" 
                                        class="input-label-secondary">
                                        <img src="{{ asset('/public/assets/admin/img/info-circle.svg') }}" 
                                            alt="{{ trans('messages.minimum_pickup_time_for_laundry_order_hint') }}">
                                    </span>

                                </label>
                                <input type="number" name="minimum_pickup_time_for_laundry_order" class="form-control"
                                    id="minimum_pickup_time_for_laundry_order" min="0" step="1"
                                    value="{{ $minimum_pickup_time_for_laundry_order ? $minimum_pickup_time_for_laundry_order->value : 0 }}"
                                    pattern="\d+" title="Please enter a whole number" required>
