        ...
        <div class="page-header">
            ...
            <div class="js-nav-scroller hs-nav-scroller-horizontal mb-2">
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link {{$tab=='details'?'active':''}}" href="{{route('admin.food.view', [$product->id])}}">{{__('messages.details')}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{$tab=='log'?'active':''}}" href="{{route('admin.food.view', [$product->id,'log'])}}"  aria-disabled="true">{{__('messages.log')}}</a>
                    </li>
                </ul>
                <!-- End Nav -->
            </div>
        </div>
        @include("admin-views.product.partials._{$tab}")
        {{-- <!-- End Page Header -->
