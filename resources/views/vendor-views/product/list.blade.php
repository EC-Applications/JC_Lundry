                        ...
                        <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
                            ...
                            @foreach($foods as $key=>$food)
                                <tr>
                                    ...
                                    <td>{{($food['price'])}}</td>
                                    <td>
                                        <form action="{{route('vendor.food.priority',$food->id)}}">
                                            <input name="priority" type="number" title="{{__('messages.priority_hint')}}" class="form-control form--control-select mx-auto {{$food->priority == 0 ? 'text-title':''}} {{$food->priority == 1 ? 'text-info':''}} {{$food->priority == 2 ? 'text-success':''}} " onchange="this.form.submit()" value="{{$food->priority}}">
                                        </form>
                                    </td>
                                    <td>
