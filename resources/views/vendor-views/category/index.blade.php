                            ...
                            <table id="columnSearchDatatable"
                                ...
                                @foreach($categories as $key=>$category)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route('vendor.category.priority',$category->id)}}">
                                                <input type="number" name="priority" id="priority" value="{{ $category->category_restaurant ? $category->category_restaurant->priority : 0 }}"  min="0" max="99999999" onchange="this.form.submit()">
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
