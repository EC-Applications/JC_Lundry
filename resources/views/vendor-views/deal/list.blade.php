        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-sm-auto">
                    <a class="btn btn-primary text-capitalize" href="{{route('vendor.deals.create')}}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="d-block text-body">
                                            {{-- <a href="{{route('vendor.deals.show',['deal'=>$deal->id])}}"></a> --}}
                                    ...
                                    <td><label class="badge badge-soft-primary">{{Str::limit($deal->restaurant?$deal->restaurant->name:__('messages.Restaurant deleted!'),20,'...')}}</label></td>
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm" for="dealCheckbox{{$deal->id}}">
                                            <input type="checkbox" onclick="location.href='{{route('vendor.deal.status',['id'=>$deal['id'],'status'=>$deal->status?0:1])}}'"class="toggle-switch-input" id="dealCheckbox{{$deal->id}}" {{$deal->status?'checked':''}}>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-white"
                                            href="{{route('vendor.deals.edit',['deal'=>$deal->id])}}" title="{{__('messages.edit')}} {{__('messages.deal')}}"><i class="tio-edit"></i>
                                        </a>
                                        ...
                                        <form action="{{route('vendor.deals.destroy',[$deal['id']])}}"
